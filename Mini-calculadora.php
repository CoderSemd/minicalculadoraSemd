...
<script type="text/javascript" src="http://localhost/php/minicalculadora/js/funciones.js"></script>
  ...
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
     ...
     <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link " href="http://localhost/php/minicalculadora/Mini-calculadora.php" style="padding-top: 25px;">Inicio</a>
      </li>
